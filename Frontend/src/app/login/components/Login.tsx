    ...
    return(
        <div className="flex justify-center items-center bg-black w-screen h-screen">
            ...
            <div className="z-20 flex flex-col items-center w-[80%] h-[90%] bg-white rounded-2xl">
                ...
                <button className=" w-[600px] h-[72px] bg-[#4F27FF] rounded-2xl border border-black text-white font-k2d text-5xl text-bold pl-8 mt-8 transform translate-x-2" onClick={()=>{console.log(data); onSubmit(true)}}>Select Role</button>
            </div>
        </div>
    )
}